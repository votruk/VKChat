...
public abstract class AbstractListViewFragment extends AbstractPullToRefreshFragment {
    ...
    public void onResume() {
        ...
        absListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(final AdapterView<?> parent, final View view, final int position, final long id) {
                ...
                AbstractListViewFragment.this.onItemClick(listItemPosition);
            }
        });
    }
    ...
    public void onPause() {
        ...
        final View topItem = absListView.getChildAt(0);
        listTopMargin = topItem == null ? 0 : topItem.getTop();
